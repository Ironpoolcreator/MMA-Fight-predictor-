    ...
    try {
      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are an expert MMA analyst with deep knowledge of fighting styles, techniques, and fighter statistics. Provide detailed, accurate, and insightful fight predictions."
          },
          {
            role: "user",
            content: prompt
    ...
    try {
      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are an expert MMA coach with deep knowledge of fighting techniques, styles, and effective game planning."
          },
          {
            role: "user",
            content: prompt
